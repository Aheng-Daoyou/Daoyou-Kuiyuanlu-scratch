...
export const YOUDU_DECREE_NODES = [
  ...
  node('decree-silent-nail', '2', '钉下无声', '镇魂灯焰消耗降低40点。', (f) => f.quietNail()),
  ...
  node('decree-one-name-one-judgment', '5', '一名一判', '目标首次进入4层后获得标记；下一次终结命中返还60灯焰。', (f) => f.enableOneNameJudgment()),
