  ...
  mirrorNode(
    {
      ...
      layerId: '1',
      name: '镜中留客',
      description: '每轮首次受到敌方直接伤害时，额外留下1层莲印。',
    },
  ...
  mirrorNode(
    {
      ...
      layerId: '1',
      name: '果不逾时',
      description: '每层莲印提供的胎相反伤比例由3%提高至4%。',
    },
  ...
  mirrorNode(
    {
      ...
      layerId: '2',
      name: '潮来不拒',
      description: '血莲听潮的直接伤害减免由15%提高至25%。',
    },
  ...
  mirrorNode(
    {
      ...
      layerId: '2',
      name: '门叩第四声',
      description: '三叩莲门额外留下第四层莲门；倒叩时允许追加第四段明确伤害。',
    },
  ...
  mirrorNode(
    {
      ...
      layerId: '4',
      name: '相外有相',
      description: '血相守胎的直接伤害减免由20%提高至30%。',
    },
  ...
  mirrorNode(
    {
      ...
      name: '莲背生血',
      description:
        '每次进入血相时，第一门神通无需消耗莲印，也能触发一次现报；莲相不受影响。',
    },
  ...
  mirrorNode(
    {
      ...
      name: '一念两照',
      description:
        '成功施展莲相神通后额外获得2层莲印；《一念生莲》气血成本增加2个百分点。',
    },
  ...
  mirrorNode(
    {
      ...
      name: '照还来处',
      description:
        '每次实际消耗1层莲印触发现报时，恢复2%最大气血；免费现报不触发。',
    },
  ...
  mirrorNode(
    {
      ...
      layerId: 'ultimate',
      name: '莲镜非台',
      description: '胎相且莲印满层时，受到的直接伤害降低10%。',
    },
  ...
  mirrorNode(
    {
      ...
      name: '万印同门',
      description:
        '莲相现报实际消耗莲印后，会再尝试消耗1层；成功时攻击神通额外造成0.60倍物攻伤害，防御神通获得8%最大气血护盾。',
    },
