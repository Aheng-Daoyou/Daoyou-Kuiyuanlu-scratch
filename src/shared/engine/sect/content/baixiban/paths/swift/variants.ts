...
export function buildSwiftAbilities(
  ...
  const active = (args: {
    ...
    const definition = BAIXIBAN_BASE_DEFINITION.abilities.find(
      ...
      (typeof BAIXIBAN_BASE_DEFINITION.abilities)[number],
      { kind: 'passive' }
    >;
  ...
  built['turning-body'] = active({
    ...
    effects: [
      ...
      selfBuff(
        ...
        [
          {
            id: 'sect.baixiban.swift.returning-swallow',
  ...
  built['shadow-step'] = active({
    ...
    effects: [
      selfBuff(
        'sect.baixiban.swift.traceless-step',
        '圆场',
        2,
        [
          {
        ...
        [
          {
            id: 'sect.baixiban.swift.traceless-step.dodge',
            eventType: GameplayTags.EVENT.DODGE,
            scope: GameplayTags.SCOPE.OWNER_AS_TARGET,
            priority: 0,
  ...
  built['sword-aegis'] = active({
    ...
    targetPolicy: { team: 'self', scope: 'single' },
    effects: [
      selfBuff('sect.baixiban.swift.wind-heart', '心戏通明', 3, [
        {
  ...
  built['nurturing-sword'] = active({
    ...
    targetPolicy: { team: 'self', scope: 'single' },
    effects: [
      selfBuff('sect.baixiban.swift.light-sword', '人戏合一', 3, [
  ...
  built['sect-ultimate'] = active({
    ...
    effects: [
        ...
        ? [
            {
              ...
              params: {
                match: { id: BAIXIBAN_STAGE_MARK_BUFF },
                displayName: '戏痕',
      ...
      // 谢幕铸盾：快途收束之时，亦以护持守住己身，炉火不散。
      selfBuff(
        'sect.baixiban.curtain-guard',
        '谢幕护持',
        2,
        [
          {
        ...
        [
          {
            id: 'sect.baixiban.curtain-guard.reflect',
            ...
            effects: [
              {
                type: 'reflect',
                params: { ratio: 0.2, maxHpRatioPerAction: 0.1 },
              },
            ],
          },
        ],
