  ...
  createBaixibanNode(
    {
      ...
      name: '无隙',
      description:
        '施展《谢幕》后，下一次《起势》不消耗灯焰，并额外获得1点戏念。',
    },
    (context, builder) => {
      ...
      addBaixibanPassive(context, builder, {
        ...
        listeners: [
          {
            id: 'sect.baixiban.swift-gapless.bonus',
        ...
        presentationModifiers: [
          {
            ...
            factRows: [
              '参悟·无隙：施展《谢幕》后，下一次《起势》不消耗灯焰，并额外获得1点戏念',
            ],
          },
        ],
      });
  ...
  createBaixibanNode(
    {
      ...
      name: '连城',
      description:
        '施展《走场》后，其他快器神通的当前冷却减少1回合，每回合最多触发一次。',
    },
    (context, builder) => {
      ...
      addBaixibanPassive(context, builder, {
        ...
        listeners: [
          {
            id: 'sect.baixiban.swift-linked-city-round.reset',
        ...
        presentationModifiers: [
          {
            ...
            factRows: [
              '参悟·连城：施展《走场》后，其他快器神通的当前冷却减少1回合，每回合最多触发一次',
            ],
          },
        ],
      });
  ...
  createBaixibanNode(
    {
      ...
      name: '静潮',
      description:
        '连续两次自身行动未施展《谢幕》后，暂停戏念衰减；下一次《谢幕》伤害提高15%。',
    },
    (context, builder) => {
      ...
      addBaixibanPassive(context, builder, {
        ...
        listeners: [
          {
            id: 'sect.baixiban.swift-still-tide.action',
          ...
          {
            id: 'sect.baixiban.swift-still-tide.damage',
        ...
        presentationModifiers: [
          {
            abilityId: 'sect-ultimate',
            factRows: [
              '参悟·静潮：连续两次自身行动未施展《谢幕》后暂停戏念衰减；下一次《谢幕》伤害提高15%',
            ],
          },
        ],
      });
