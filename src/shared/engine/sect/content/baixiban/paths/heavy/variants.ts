...
const reductionListeners = (value: number) => [
  {
    id: `sect.baixiban.heavy.reduction.${value}`,
...
export function buildHeavyAbilities(
  ...
  built['turning-body'] = active({
    ...
    castEffects: [
        ...
        : []),
      {
        type: 'queue_action',
        params: {
          id: 'sect.baixiban.heavy.thunder-strike',
          name: '听雷',
          tags: [
            ...
            GameplayTags.ABILITY.SECT.path(BAIXIBAN_SECT_ID, path.pathId),
  ...
  built['shadow-step'] = active({
    ...
    effects: [
      ...
      selfBuff(
        'sect.baixiban.heavy.mountain-step',
        '圆场',
        2,
  ...
  built['sword-aegis'] = active({
    ...
    effects: [
      ...(features.immovableMountain
        ...
        : []),
      selfBuff(
        'sect.baixiban.heavy.mountain-heart',
        '心戏通明',
        3,
        [
          {
        ...
        [
          ...
          ...(features.immovableMountain
            ? [
                {
                  id: 'sect.baixiban.heavy.immovable.counter',
  ...
  built['nurturing-sword'] = active({
    ...
    effects: [
      selfBuff(
        'sect.baixiban.heavy.weightless-edge',
        '人戏合一',
        3,
        [
