  ...
  createBaixibanNode(
    {
      ...
      name: '横关',
      description:
        '每回合首次以护盾吸收直接伤害时，反击造成相当于55%物攻的伤害，并获得1点戏念。',
    },
    (context, builder) =>
      addBaixibanPassive(context, builder, {
        ...
        listeners: [
          {
            id: 'sect.baixiban.heavy.crossbar',
  ...
  createBaixibanNode(
    ...
    (context, builder) =>
      addBaixibanPassive(context, builder, {
        ...
        listeners: [
          {
            id: 'sect.baixiban.heavy.borrow-force',
            eventType: GameplayTags.EVENT.DAMAGE_TAKEN,
            scope: GameplayTags.SCOPE.OWNER_AS_TARGET,
            priority: 0,
            mapping: { caster: 'owner', target: 'event.caster' },
            ...
            effects: [
              {
                type: 'damage_memory',
                params: {
                  key: 'sect.baixiban.heavy.borrow-force',
                  mode: 'record',
  ...
  createBaixibanNode(
    ...
    (context, builder) =>
      addBaixibanPassive(context, builder, {
        ...
        listeners: [
          {
            id: 'sect.baixiban.heavy.shocking-edge',
            eventType: GameplayTags.EVENT.DAMAGE_TAKEN,
            scope: GameplayTags.SCOPE.OWNER_AS_TARGET,
            priority: 0,
            mapping: { caster: 'owner', target: 'event.caster' },
