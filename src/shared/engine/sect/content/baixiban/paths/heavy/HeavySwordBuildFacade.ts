...
export class HeavySwordBuildFacade {
  ...
  finalize(): void {
    ...
    if (!resource) throw new Error('重器构筑缺少宗门战斗资源');
...
export function initializeHeavySwordBuild(
  ...
  builder.setAbility(
    ...
    factory.passive({
      definition: BAIXIBAN_BASE_DEFINITION.abilities.find(
      ...
      listeners: [
        {
          id: 'sect.baixiban.heavy.shield-momentum',
