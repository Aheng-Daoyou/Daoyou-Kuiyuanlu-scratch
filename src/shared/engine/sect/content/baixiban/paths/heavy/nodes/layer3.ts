  ...
  createBaixibanNode(
    {
      ...
      layerId: '3',
      name: '镇关',
      description: '《圆场》提供的护盾提高50%。',
    },
    (_context, builder) => heavySwordBuild(builder).enable('mountainGate'),
    (context) =>
      `《圆场》提供的护盾提高50%，当前获得相当于${nodePercent(growthShieldMagnitude(context, 'void-step', 0.52 * 1.5))}物攻的护盾。`,
  ),
  createBaixibanNode(
    {
    ...
    (context, builder) =>
      addBaixibanPassive(context, builder, {
        ...
        listeners: [
          {
            id: 'sect.baixiban.heavy.returning-wave',
  ...
  createBaixibanNode(
    ...
    (context, builder) =>
      addBaixibanPassive(context, builder, {
        ...
        listeners: [
          {
            id: 'sect.baixiban.heavy.solid-guard',
