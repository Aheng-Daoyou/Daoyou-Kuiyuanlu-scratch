...
export const BAIXIBAN_SECT_PRESENTATION: SectPresentationTheme = {
  sectId: BAIXIBAN_SECT_ID,
  announcement:
    '近日山下商路多有邪修出没，外出历练者须结伴而行；归宗后记得向班务房补录见闻。',
  visual: {
    sigilLabel: '百戏谢幕',
    sigilGlyph: '戏',
    palette: ['#1a1412', '#6b2f2a', '#d8a03a'],
    motto: '戏演两遍，谢幕方知。',
    motif: '半山戏台朝向城郭，台上灯影未散，台下已有人下山。',
  },
  onboarding: {
    summary:
      '自市井间学戏，以平生所见养出戏念，在照影游尘与守拙藏锋之间走出自己的戏路。',
    traits: ['入世问戏', '快重由心', '谢幕'],
    script: {
      id: 'baixiban-onboarding',
      title: '人间问戏',
      theme: 'steel',
      backdrop: {
        src: '/assets/sect/onboarding/baixiban.webp',
        alt: '百戏班山门朝向山下城郭，背箱艺人沿石阶往来于山门与人间',
      },
      acts: [
        {
          id: 'downhill-gate',
          title: '山下之门',
          scene: '百戏班 · 山门',
          body: '山门立在半山，门外石阶没有隐入云海，而是一路通向炊烟初起的城郭。有人整肃行头，正背箱下山；也有人带着满身风尘，从长路归来。',
          speaker:
            '守门弟子：“上山学戏，下山走场。百戏班的路，从来要走两遍。”',
        ...
        },
        {
          ...
          title: '先问其戏',
          scene: '百戏班 · 班口',
          body: '传灯长老没有命你劈开试戏石，只从旧箱里取出一件寻常封灵器，横放在你面前。器身不见异光，器柄上却留着许多经年磨痕。',
          speaker: '传灯长老：“戏能演什么，不难。难的是你要知道，什么不该演。”',
        ...
        },
        {
          ...
          title: '百戏谱',
          scene: '百戏班 · 戏匣阁',
          body: '旧卷中既有身段，也夹着地名、人名、残缺书信与未能兑现的约定。许多段落只有寥寥数笔，却被后来者反复翻阅。',
          speaker:
            '守阁长老：“戏法可以传，平生不可照抄。前人的答案，只能替你问出自己的问题。”',
        ...
        },
        {
          ...
          title: '两道戏途',
          scene: '百戏班 · 戏台崖',
          body: '崖前戏影一快一重。快戏连绵，转瞬已在石壁留下数道戏痕；重戏静立，直至来势逼近，才以后发一击震开尘土。',
          speaker:
            '传灯长老：“照影游尘，见招而变；守拙藏锋，承势而决。戏路不同，最后问的却是同一件事。”',
        ...
        },
        {
          ...
          title: '谢幕',
          scene: '百戏班 · 弟子名册前',
          body: '你的名字被写入弟子名册，《百戏谱》中属于你的那一页仍然空白。长老合上旧卷，将那件封灵器连同器匣一并交到你手中。',
          speaker:
            '传灯长老：“今日不必写。等你真正明白为何登台，再回来落这一笔。”',
  ...
  map: {
    image: '/assets/sect/baixiban-map.webp',
    alt: '百戏班殿阁、戏台、工坊、矿场与灯下草圃沿山路连接山下城郭的水墨鸟瞰图',
    aspectRatio: 1260 / 902,
    hotspots: [
      {
        id: 'hall',
        label: '班口',
      ...
      },
      {
        ...
        visitor: {
          description:
            '戏痕沿群峰与山路首尾相接，外客只能在阵外看见偶尔掠过云层的锋光。',
        },
      },
    ],
  },
  ...
  scenes: {
    ...
    hall: {
      title: '班口',
      description:
        '堂中不设试戏石，只悬历代门人的旧器与归宗名册；身份玉牒、俸禄名册皆由录事在此核验。',
    },
    affairs: {
      title: '班务房',
      description:
    ...
    archive: {
      title: '戏匣阁',
      description:
        '檀木长架上既有六卷心法，也收着历代弟子的行器手记；在此逐卷研习，不必再穿行别阁。',
      loadingText: '戏匣阁卷帙正在归架……',
    },
    paths: {
      title: '戏台崖',
      description:
        '崖壁遍布历代门人留下的试戏痕迹，快重二道皆由此分流；择定道途后，沿灯脉继续参悟。',
      loadingText: '崖前戏影正在散开……',
    },
    arena: {
      title: '戏台',
      description:
        '演武场中央阵纹已启，宗门神通将在当前流派与参悟方案下显化威能。',
      loadingText: '戏台阵纹徐徐亮起……',
    },
    treasury: {
      title: '行头箱',
      description:
  ...
  rooms: {
    affairs: {
      description:
        '旧器与功簿分列堂中，三席经办之人各守一案。寻到对应之人，便可当面接下或交回事务。',
      actors: {
        daily: {
          id: 'baixiban-lin-yanqiu',
          name: '陆青崖',
          greeting: '今日事务已经理清，你先说想办哪一桩。',
        },
        weekly: {
          id: 'baixiban-gu-wenfeng',
          name: '裴守拙',
          greeting: '本周功簿在此，小比与悬赏也都记着。',
        },
        promotion: {
          id: 'baixiban-xie-tingyun',
          name: '听戏老人',
          greeting: '晋升问的不是锋芒多少，而是这一器为何而出。',
        },
      },
    },
    hall: {
      actors: {
        registry: {
          id: 'baixiban-shen-chijian',
          name: '顾怀真',
          greeting: '玉牒和同门名录都已理好，你想查哪一项？',
        },
        stipend: {
          id: 'baixiban-wen-fenglu',
          name: '柳七',
    ...
    industries: {
      actors: {
        construction: {
          id: 'baixiban-zhu-baigong',
          name: '杜长庚',
          greeting: '各处设施修到哪里、还差多少，我都能说给你听。',
        },
        donation: {
          id: 'baixiban-shi-sanjin',
          name: '苗小满',
    ...
    arena: {
      actors: {
        instructor: {
          id: 'baixiban-fu-shifeng',
          name: '霍千钧',
          greeting: '招式合不合手，上场一试便知；先把你的神通排给我看。',
        },
        marshal: {
          id: 'baixiban-chen-shoutai',
          name: '苏放鹤',
    ...
    alchemy: {
      actors: {
        keeper: {
          id: 'baixiban-yan-danshi',
          name: '程晚照',
          greeting: '火候正好，想先问调香房灯效，还是直接开炉？',
        },
      },
    },
    refinery: {
    ...
    spiritVein: {
      actors: {
        keeper: {
          id: 'baixiban-luo-tingmai',
          name: '邵沉川',
          greeting: '矿道巡视封签已经备好，有差事便在这里核对。',
        },
        facility: {
          id: 'baixiban-lingmai-kuangchang',
          name: '梦涎井',
    ...
    herbGarden: {
      actors: {
        keeper: {
          id: 'baixiban-he-caowei',
          name: '秦晚晴',
          greeting: '晨露刚退，田里长势不错，草木值录已经写好了。',
        },
        facility: {
          id: 'baixiban-zongmen-yaotian',
          name: '宗门灯下草圃',
  ...
  terms: {
    pathChanges: '戏路变化',
    meridianPractice: '器道参悟',
    meridianLoadout: '参悟方案',
    abilityChanges: '神通变化',
    returnToAffairs: '返回班务房',
  },
};
