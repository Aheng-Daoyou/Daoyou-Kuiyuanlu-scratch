...
export function addProbingNodePassive(
  ...
  addPassive(context, builder, {
    ...
    listeners: [
      {
        id: `sect.baixiban.${args.id}.counter`,
    ...
    presentationModifiers: [
      {
        ...
        factRows: [
          '参悟·探虚：《亮相》每累计命中2次，额外获得1点戏念，并施加1层戏痕',
        ],
      },
    ],
  });
...
export function addHiddenNodePassive(
  ...
  addPassive(context, builder, {
    ...
    listeners: [
      {
        id: `sect.baixiban.${args.id}.first-hit`,
...
export function addBorrowedNodePassive(
  ...
  addPassive(context, builder, {
    ...
    listeners: [
      {
        id: `sect.baixiban.${args.id}.damage`,
...
export function addBaixibanPassive(
  context: SectNodeApplyContext,
  builder: SectBuildBuilder,
