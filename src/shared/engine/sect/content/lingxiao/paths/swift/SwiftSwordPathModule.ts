...
const SWIFT_SWORD_DEFINITION: SectPathDefinitionWithoutNodes = {
  ...
  presentation: {
    highlights: [
      { name: '连击留痕', description: '以迅疾连击施加照痕。' },
      { name: '灯影借势', description: '以灯影、闪避与反击维持攻势。' },
      { name: '诸影归灯', description: '将香火转化为连续斩击。' },
    ],
    abilityChanges: {
      'plain-sword': '牺牲少量基础威力，维持稳定积势。',
      'sect-ultimate': '将香火凝为一记主斩，并可引爆照痕追加伤害。',
      'guiding-sword': '灯影高于目标时追加追击，强化抢攻能力。',
      'linked-edge': '改为三段连击，获得更多香火并施加照痕，不再进入调息。',
  ...
  tactics: [
    {
      id: 'aggressive',
      name: '追风',
      description: '香火达到3点即可施展《照灯平生》，优先追击气血较低的目标。',
    },
    {
      id: 'steady',
      name: '连势',
      description: '照痕不足2层时优先补痕，达到6点香火且照痕充足后收束。',
    },
    {
      id: 'counter',
      name: '回燕',
      description:
        '优先补《守灯听漏》；灯影不占优且《踏影无痕》缺失时，先踏影再施展《灯荡山河》；香火达到5点后收束。',
    },
  ],
};
