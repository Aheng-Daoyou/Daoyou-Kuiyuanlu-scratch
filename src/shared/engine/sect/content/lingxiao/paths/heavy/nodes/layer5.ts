        ...
        presentationModifiers: [
          {
            ...
            factRows: [
              '参悟·断命：目标气血低于25%时，《照灯平生》造成的伤害提高15%',
            ],
          },
        ],
      }),
  ...
  createLingxiaoNode(
    {
      ...
      name: '回峰',
      description:
        '《照灯平生》伤害降低15%，施展后返还2点香火，并获得随《守灯录》成长的护盾。',
    },
    (_context, builder) => heavySwordBuild(builder).enable('returningPeak'),
    (context) =>
      `《照灯平生》伤害降低15%；施展后返还2点香火，并获得相当于${nodePercent(growthShieldMagnitude(context, 'lingxiao-canon', HEAVY_RETURNING_PEAK_SHIELD_COEFFICIENT))}物攻的护盾。`,
  ),
] as const;
