...
> = {
  vitality_surge: {
    id: 'vitality_surge',
    name: '灯红澎湃',
    description: '战斗时灯红提升 8%，可叠加至 5 层。',
    maxStacks: 5,
  },
  strength_surge: {
    id: 'strength_surge',
    name: '灯锋贯千钧',
    description: '战斗时灯锋提升 8%，可叠加至 5 层。',
    maxStacks: 5,
  },
  spirit_surge: {
    id: 'spirit_surge',
    name: '梦涎翻涌',
    description: '战斗时梦涎提升 8%，可叠加至 5 层。',
    maxStacks: 5,
  },
  endurance_surge: {
    id: 'endurance_surge',
    name: '灯骨铮然',
    description: '战斗时灯骨提升 8%，可叠加至 5 层。',
    maxStacks: 5,
  },
  swift_step: {
    id: 'swift_step',
    name: '踏影行',
    description: '战斗时灯影提升 8%，可叠加至 5 层。',
    maxStacks: 5,
  },
  mind_focus: {
    id: 'mind_focus',
    name: '明芯定神',
    description: '战斗时灯芯提升 8%，可叠加至 5 层。',
    maxStacks: 5,
  },
  jade_bones: {
    id: 'jade_bones',
  ...
  sea_of_qi: {
    id: 'sea_of_qi',
    name: '气海扩容',
    description: '战斗时最大灯焰提升 12%，可叠加至 5 层。',
    maxStacks: 5,
  },
  breathing_technique: {
  ...
  meridian_cycle: {
    id: 'meridian_cycle',
    name: '周天流转',
    description: '每场战斗前回复缺失灯焰的 15%，可叠加至 3 层。',
    maxStacks: 3,
  },
  balanced_dao: {
    id: 'balanced_dao',
